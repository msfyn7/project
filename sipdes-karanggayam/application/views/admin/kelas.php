      ...
      <div class="card">
        <div class="header">
                <div class="ml-1 mb-2 mr-2 float-left">
                    <a type="button" class="btn btn-primary ml-2 mt-2" href="<?php echo base_url('admin/tambahKelas');?>">
                    Tambah Kelas</a>
                </div>
    ...
    <div class="content">
			...
			<?php $i=1; foreach ($kelas as $kls) { ?>      
							...
							<tr>
                                ...
                                <td><?php echo $kls['pengajar'] ?></td>
								<td class="tindakan">
                                    <div class="btn-group d-none d-md-inline" role="group">
                                        <a href="#" class="btn btn-info" title="Lihat"><i class="fas fa-eye"></i> Lihat</a>
                                        <a href="#" class="btn btn-success" title="Ubah"><i class="fas fa-pen"></i> Edit</a>
                                        <a href="<?php echo base_url('admin/deleteKelas/'. $kls['id_kelas']); ?>" class="btn btn-danger" onclick="return confirm('Apakah kamu yakin mau menghapus data ini?')" title="Hapus"><i class="fas fa-trash"></i> Delete</a>
                                    </div>
                                    <div class="d-inline d-md-none">
                                        <div class="btn-group" role="group">
                                            <a href="#" class="btn btn-info" title="Lihat"><i class="fas fa-eye"></i></a>
                                            <a href="#" class="btn btn-success" title="Ubah"><i class="fas fa-pen"></i></a>
                                            <a href="<?php echo base_url('admin/deleteKelas/'. $kls['id_kelas']); ?>" class="btn btn-danger" onclick="return confirm('Apakah kamu yakin mau menghapus data ini?')" title="Hapus"><i class="fas fa-trash"></i></a>
                                        </div>
                                    </div>
                                </td>
							</tr>
