<!DOCTYPE html>
    ...
    <head>
        ...
        <title>Pemerintah Desa Karang Gayam</title>
    </head>
    <body>
        <!--=============== HEADER ===============-->
        <header class="header" id="header">
            <nav class="nav container">
                <a href="#" class="nav__logo">Pemerintah Desa Karang Gayam</a>
                    ...
                    <ul class="nav__list">
                        ...
                        <li class="nav__item">
                            <a href="#about" class="nav__link">
                                ...
                                <span class="nav__name">Akademik</span>
                            </a>
                        </li>
                ...
                <!--<img src="assets/img/perfil.png" alt="" class="nav__img img-circle elevation-3">-->
        ...
        <main>
            ...
            <section class="container section section__height" id="about">
                <h2 class="section__title">Akademik</h2>
            </section>

            <!--=============== SKILLS ===============-->
            <section class="container section section__height" id="skills">
                <h2 class="section__title">Informasi</h2>
            </section>
